...
Leia cada frase com calma. Marque VERDADEIRO se aquilo já aconteceu com você — mesmo que tenha sido poucas vezes. Marque FALSO só se nunca viveu aquela situação.`,
  ...
  results: [
    ...
    },
    {
      ...
      cost: "Quando esse tipo de situação se repete muitas vezes, o impacto vai muito além do emocional. Com o tempo, isso muda a forma como você se vê, como fala de si mesma e até o espaço que sente que pode ocupar numa relação. Aos poucos, colocar limites começa a parecer egoísmo. Pedir cuidado parece fraqueza. E o cansaço que você sente passa a parecer exagero — quando, na verdade, é um sinal claro de que algo, há muito tempo, não está equilibrado.",
